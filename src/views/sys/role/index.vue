<template>
  ...
  <MenuDialog v-model="menuDialogVisible" :sysMenuList="sysMenuList" :menuDialogVisible="menuDialogVisible" :id="id" @initRoleList="initRoleList"></MenuDialog>
...
const  initRoleList = async ()=>{
  const res=await request.post("sys/role/list",queryForm.value);
...
const handleDelete=async (id)=>{
  ...
  const res=await request.post("sys/role/delete",ids)
